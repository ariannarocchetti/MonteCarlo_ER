...
material_array = ["SS_OuterCryostat", "OuterCryostatReflector",  "Copper_TopRing","Copper_FieldGuard_",
                "Copper_FieldShaperRing_"]
#isotope_array = ["Th232"]
...
command = ("ls -d raw_files/20191209*")
...
for i in range(0, len(out)-1):
     ...
     print("cp %s/*_Sort.root %s" %(storage_path+"/"+out[i], storage_path ))
     os.system("cp %s/*_Sort.root %s" %(storage_path+"/"+out[i], storage_path ))   
